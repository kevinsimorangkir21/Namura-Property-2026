...
import { Save, Upload, X, ArrowLeft, MapPin } from "lucide-react";
...
export default function EditPropertiPage() {
  const [form, setForm] = useState({
    ...
    luasTanah: "180",
    deskripsi:
      "Hunian modern dengan lokasi strategis dan akses mudah ke pusat kota.",
  });
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-0.5">
            Perbarui informasi properti yang sudah ada.
          </p>
        </div>
